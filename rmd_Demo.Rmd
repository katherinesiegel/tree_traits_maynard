...
### fix trait names
```{r}
### make vector of trait IDs
try_trait_id_vect <- c(3106, 3117, 47, 719, 3107, 
                       2, 53, 928, 45, 4, 1238, 1237,
                       281, 49, 169, 63, 3441, 364, 77, 
                       819, 28, 24)

### make vector of trait names
trait_name <- c("Plant height vegetative", 
