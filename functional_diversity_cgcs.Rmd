...
### make a boxplot
```{r}
### install packages for boxplot
install.packages("gridExtra")
library(gridExtra)

### open fd metrics files
t1_fd_all <- read.csv("our_data/functional_diversity/t1_fd_metrics.csv")

t2_fd_all <- read.csv("our_data/functional_diversity/t2_fd_metrics.csv")
...
fric_all <- rbind(t1_fric, t2_fric)

ggplot(fric_all, aes(x = time_step, y = fric, fill = time_step)) +
  geom_boxplot() +
...
fdis_all <- rbind(t1_fdis, t2_fdis)

ggplot(fdis_all, aes(x = time_step, y = fdis, fill = time_step)) +
  geom_boxplot() +
  #theme(panel.background = element_rect(fill = grey)) +
  #facet_wrap(~ time_step) +
  theme_bw() +
...
fdiv_all <- rbind(t1_fdiv, t2_fdiv)

ggplot(fdiv_all, aes(x = time_step, y = fdiv, fill = time_step)) +
  geom_boxplot() +
  #theme(panel.background = element_rect(fill = grey)) +
  #facet_wrap(~ time_step) +
  theme_bw() +
...
feven_all <- rbind(t1_feven, t2_feven)

ggplot(feven_all, aes(x = time_step, y = feven, fill = time_step)) +
  geom_boxplot() +
  #theme(panel.background = element_rect(fill = grey)) +
  #facet_wrap(~ time_step) +
  theme_bw() +
